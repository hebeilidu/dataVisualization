...
$(function () {
    ...
    function echarts_2() {
        ...
        option = {
            ...
            series: [{
                ...
                data: [
                    {value: 34, name: '35岁及以下',},
                    {value: 77, name: '36-45岁',},
                    {value: 26, name: '46-55岁',},
                    {value: 4, name: '56岁及以上',},
    ...
    function echarts_10() {
        ...
        var getxb1 = 20; //实验教学学分
        var getxb2 = 150; //非实验教学学分
        var xbzb = [11.76, 88.24];
...
var option = {
	...
	yAxis: {
		data: ['硕、博学位教师','境内外培训进修教师','35岁以下青年教师','高级职称教师','其中低年级授课教授','授课教授比例'],
		//offset: 15,
		axisTick: {
			show: false
		},
	...
	series: [{
		...
		barWidth: '15',
		data: [91.67, 2.13, 24.11, 45.31, 50, 7.29],
		z: 10
	}, {
		type: 'bar',
		barGap: '-100%',
